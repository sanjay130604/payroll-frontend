...
import { User, History, Info, HelpCircle } from "lucide-react";
...
export default function Sidebar({ mobileMenuOpen, setMobileMenuOpen }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:static inset-y-0 left-0 z-50 w-72 bg-white border-r border-slate-100 flex flex-col shadow-2xl md:shadow-sm transform transition-transform duration-300 ease-in-out
